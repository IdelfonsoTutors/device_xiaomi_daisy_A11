 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.1-service.xiaomi_daisy"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.1-service.xiaomi_daisy"
...
static const std::vector<hw_module_info_t> kHALModules = splitIntoVector("fingerprint,fpc gf_fingerprint,goodix");
